...
public class PrincipalController extends BaseController implements Serializable {
	...
	public String direcionaCadastroPreRegistro() {
		return EnumPaginas.CADASTRO_PRE_REGISTRO.getUrl();
	}
	
	public String direcionaVisualizarPreRegistro() {
		return EnumPaginas.VISUALIZAR_PRE_REGISTRO.getUrl();
	}
