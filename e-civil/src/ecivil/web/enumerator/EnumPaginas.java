...
public enum EnumPaginas {
	...
	CADASTRO_PRE_REGISTRO("/pages/preregistro/cadastroPreRegistro.jsf", "Cadastro Pré-Registro"),
	VISUALIZAR_PRE_REGISTRO("/pages/preregistro/visualizarPreRegistro.jsf", "Vizualizar Pré-Registro");
