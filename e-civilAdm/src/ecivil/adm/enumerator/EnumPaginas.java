...
public enum EnumPaginas {
	...
	PRE_REGISTRO_PRE_POSTO("/pages/preregistro/preRegistroPrePosto.xhtml", "Pré-Registro"),
	DECLARACOES_PRE_REGISTRO_PRE_POSTO("/pages/preregistro/declaracoesPreRegistroPrePosto.xhtml", "Declarações Pré-registro"),
