...
public enum EnumPaginas {
	...
	PRE_REGISTRO_PRE_POSTO("/pages/registro/registroPrePosto.xhtml", "Registro"),
	PESQUISA_PRE_REGISTRO("/pages/registro/pesquisaRegistro.xhtml", "Registro"),
	DECLARACOES_PRE_REGISTRO_PRE_POSTO("/pages/registro/declaracoesRegistroPrePosto.xhtml", "Declarações Registros"),
